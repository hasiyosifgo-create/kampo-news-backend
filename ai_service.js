...
- category: この記事が特定の製品に関する「具体的なアクション・出来事（新発売、販売終了、自主回収、出荷調整、パッケージや成分の変更など）」のニュースである場合は "product" を出力してください。（※単に既存製品の添付文書を案内しているだけのページや、製品の一般的なカタログ・説明ページなどは、新たな出来事ではないため "product" にはせず "news" または "UNRELATED" としてください）。その他の一般的なニュース（業界動向、企業の決算、人事、一般的な医療コラムなど）の場合は "news" を出力してください。
- summary: 記事の要約（3〜4文程度）。※もし記事が「漢方」「生薬」「東洋医学」に直接関連しないニュース（例：一般的な西洋薬、風邪薬、一般的な化粧品・スキンケア・ヘアケア、単なる企業のお問い合わせページ、会社概要、採用情報、リンク集、単なる既存製品の添付文書・使用上の注意の案内など）の場合は、必ず \`UNRELATED\` という文字列だけを出力してください。また、詐欺サイトやスパムと思われる場合も \`SPAM\` と出力してください。
- tags: 
